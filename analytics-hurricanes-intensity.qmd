...
NATL.df <- hockeystick::get_hurricanes()

NATL.df |>
  hockeystick::plot_hurricane_nrg()
```
...
-   The National Hurricane Center has data on all tropical cyclones occurring in the North Atlantic and western North Pacific. These data are available [here](https://www.nhc.noaa.gov/data/)

-   The International Best-Track Archive for Climate Stewardship has historical tropical cyclone data from around the world in CSV, netCDF, and shapefiles are available. These data are available [Here](https://www.ncei.noaa.gov/data/international-best-track-archive-for-climate-stewardship-ibtracs/v04r00/access)
...
Multiply .004 by 100 to get .4 percent per year or 4% per decade since 1950
