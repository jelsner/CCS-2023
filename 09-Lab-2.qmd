...
## 3 
Add a trend line to the graph (4)

## 4
Quantify the amount of change using a linear regression model (4)

## 5
Type your answers below to the following questions: According to Pacos Hank video entitled "Tornadoes of 2022", how many tornadoes were recorded across the United States last year (2022)? (2)
