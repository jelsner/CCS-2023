...
-   Paleotempestology 
![overwash](figures/ovrwsh.gif)

##

![Vibracore](figures/Vibracore.jpg) 
![Sedimentcore](figures/SedimentCore.jpg)


## 

-   Maximum potential intensity (MPI) ![MPI](figures/MPI.png)
-   Lifetime maximum intensity (LMI) ![LMI](figures/LMI.png)

## 

-   Limiting intensity (LI) ![LI](figures/LI.png)
-   LI vs SST ![LIvsSST](figures/LIvsSST.png)

## 

-   Sensitivity of LI to SST ![sensitivity](Sensitivity.png)
