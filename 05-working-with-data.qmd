...
-   Lab 1 on Wednesday
-   Using verbs to manipulate a data frame
...
-   The `dim()` function applied to the data frame returns the size of the data frame in terms of how many rows (first number) and how many columns
