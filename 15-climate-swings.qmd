...
<<<<<<< HEAD
-   The swinging climate outside and inside pushes
=======
This shit doesn't work!

{{< video https://www.youtube.com/embed/SVDEE30XB5A >}}
...
-   Internal factors
    - El Niño
>>>>>>> edef961334679c91a0625c2ed92bef59f203c9f7

##

-   Outside pushes over centuries to millennium
-   Orbital changes (Milankovitch cycles)
    - Shape of Earth’s orbit: eccentricity
    - Angle at which Earth’s axis is tilted with respect to Earth’s orbital plane: obliquity
    - Direction Earth’s axis of rotation is pointed: precession
    
##

-   Outside pushes on months to years
-   Volcanic activity can affect the climate
-   Large volcano eruptions --> cool the atmosphere {{< video https://www.youtube.com/embed/H5kQYlDoS48 >}} 2 minutes

##

-   Changes on the sun can affect the climate
-   Times of maximum sunspot activity are times with slightly more energy output from the sun (mostly ultraviolet) {{< video https://www.youtube.com/embed/wWIh3PvQscQ >}} 5 minutes

##

-   Daily sunspot counts from <https://www.sidc.be/silso/datafiles#total>
-   Data are in your file `Sunspots.txt` in your directory `data`
...
ssn.df <- readr::read_table(file = here::here("data", "Sunspots.txt"),
  ...
  dplyr::filter(Year >= 1900, Year <= 2021)
```
...
-   El Niño is part of an internal climate swing {{< video https://www.youtube.com/embed/WPA-KpldDVc >}} 4 minutes
...
-   Note the upward trend toward stronger El Ninos

##

-   Plot the upward trend in the strong El Ninos with the `geom_quantiles()` function setting `quantiles = .99`
