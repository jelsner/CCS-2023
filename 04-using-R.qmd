...
-   The package {ggplot2} has functions for making plots. We will also use the package {hockeystick} that has functions for downloading and plotting climate data.
