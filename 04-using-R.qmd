...
-   The package {ggplot2} has functions for making plots. We will also use the package {hockeystick} that has functions for downloading a plotting climate data.
...
Download and install the {tidyverse} set of packages