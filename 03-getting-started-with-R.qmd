...
-   R is an interpreted language unlike Excel or SPSS with point-and-click interaction
-   You must type in commands written in code. In other words, you must code/program. I use "coding" and "programming" interchangeably
-   To begin you need some basic concepts

## 

-   *Console pane*: where you enter in commands
-   *Running code*: the act of telling R to do something by giving it commands
...
-   Data in R where rows are observations and columns are variables that describe the observations. They are rectangular spreadsheets
