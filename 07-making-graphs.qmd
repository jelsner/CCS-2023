...
-   Lab 2 will be next Monday (February 13)
-   It will cover material from Lessons 7 & 8
-   Today: graphing climate change data

## 

-   Climate is a data-generating machine
-   Graphs of observed data help you to understand processes within the climate machine
...
-   The {ggplot2} package has functions to make graphs rooted in a visualization theory
...
-   Write code to make a scatter plot in R
-   Copy/paste the generated code into your Console
-   Good. Now write code to make a time series plot
