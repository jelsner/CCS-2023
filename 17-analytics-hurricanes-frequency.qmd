...
-   Analyzing and modeling frequency
-   No class on Thursday, Lab 4 next Tuesday
...
-   Click on it
-   Get these data into your current R session
...
-   `TS` number of tropical storms (tropical cyclone with winds of at least 17 m/s, 33 kt, 40 mph)
-   `H` number of hurricanes (tropical storms with winds of at least 33 m/s, 64 kt, 75 mph)
-   `MH` number of major hurricanes (hurricanes with winds of at least 50 m/s, 97 kt, 111 mph)
-   winds refer to the maximum sustained (1 minute) at a height of 10 m above the surface (land or ocean)
...
-   Annual number of hurricanes vs annual average temperature
...
-   What count is most common? What is the value of the average count? What is the value of the variance? What is the value of the ratio of the variance to the average?

##

-   These questions are answered with the following code chunk
